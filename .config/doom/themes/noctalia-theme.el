...
(let* ((bg "#2d353b")
      (err "#e67e80")
      (err-container "#a21012")
      (on-background "#d3c6aa")
      (on-err "#2d353b")
      (on-err-container "#f7d4d5")
      (on-primary "#2d353b")
      (on-primary-container "#e7eedd")
      (on-secondary "#2d353b")
      (on-secondary-container "#deedeb")
      (on-surface "#d3c6aa")
      (on-surface-variant "#d3c6aa")
      (on-tertiary "#2d353b")
      (on-tertiary-container "#f7dfd4")
      (outline-color "#7a8478")
      (outline-variant "#555c54")
      (primary "#a7c080")
      (primary-container "#4e6924")
      (secondary "#7fbbb3")
      (secondary-container "#25635a")
      (shadow "#232a2e")
      (surface "#2d353b")
      (surface-container "#3d484d")
      (surface-container-high "#465358")
      (surface-container-highest "#4f5d64")
      (surface-container-low "#353e44")
      (surface-container-lowest "#30383e")
      (surface-variant "#3d484d")
      (tertiary "#e69875")
      (tertiary-container "#9b390d")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#e69875")
      (on-success "#2d353b")
      (success-container "#9b390d")
      (on-success-container "#f7dfd4")
      ;; Map fixed colors to regular colors
      (primary-fixed "#a7c080")
      (primary-fixed-dim "#4e6924")
      (secondary-fixed "#7fbbb3")
      (secondary-fixed-dim "#25635a")
      (tertiary-fixed "#e69875")
      (tertiary-fixed-dim "#9b390d")
      (on-primary-fixed "#2d353b")
      (on-primary-fixed-variant "#e7eedd")
      (on-secondary-fixed "#2d353b")
      (on-secondary-fixed-variant "#deedeb")
      (on-tertiary-fixed "#2d353b")
      (on-tertiary-fixed-variant "#f7dfd4")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#d3c6aa")
      (inverse-primary "#a7c080")
      (inverse-surface "#2d353b")
